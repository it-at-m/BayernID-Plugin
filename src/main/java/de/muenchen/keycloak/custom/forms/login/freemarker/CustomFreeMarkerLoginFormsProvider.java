...
public class CustomFreeMarkerLoginFormsProvider extends FreeMarkerLoginFormsProvider {
    ...
    public static final String FALLBACK_VALUE_AUTHLEVEL = "unset";
    ...
    protected void createCommonAttributes(final Theme theme, final Locale locale, final Properties messagesBundle, final UriBuilder baseUriBuilder,
        ...
        // Um sicherzugehen, dass das Property in Freemarker garantiert vorhanden ist, wird es fix gesetzt.
        this.attributes.put("authlevel", FALLBACK_VALUE_AUTHLEVEL);
        ...
        IdentityProviderBean customIpb = new CustomIdentityProviderBean(ipb);
        this.attributes.put(SOCIAL, customIpb);
    }
